...
const DeleteSong = (props) => {
    ...
    return (
        <Button variant="btn btn-outline-secondary" onClick={handleClick} style={{'marginLeft':'1em'}} data-toggle='popover' title='Delete Song' data-content='Delete Song' trigger='hover'>
